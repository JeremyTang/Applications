...
public class ThreadPoolManager {
	...
	public synchronized static void buildInstance(String threadPoolManagerName,
			int corePoolSize, int maximumPoolSize, long keepAliveTime,
			TimeUnit unit) {
		buildInstance(threadPoolManagerName, corePoolSize, maximumPoolSize,
				keepAliveTime, unit, false);
	}
	...
	public synchronized static void buildInstance(String threadPoolManagerName,
		...
		if (threadPoolManagerName == null
				|| "".equals(threadPoolManagerName.trim()) || corePoolSize < 0
